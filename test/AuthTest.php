...
class AuthTest extends AsyncTestCase
{
    ...
    {
        $redis = new Redis(createRedisClient(\sprintf(self::URI_FORMAT, self::PORT, self::PASSWORD)));
    ...
    {
        $redis = new Redis(createRedisClient(\sprintf(self::URI_FORMAT, self::PORT, 'wrong')));
